...
export interface ChainStorage<Rv extends RpcVersion>
  ...
  /**
   * Pallet `PartyIdentifiers`'s storage queries
   **/
  partyIdentifiers: {
    /**
     ...
     * @param {Callback<bigint> =} callback
     **/
    nextId: GenericStorageQuery<Rv, () => bigint>
     ...
     * @param {Callback<bigint | undefined> =} callback
     **/
    hashIndex: GenericStorageQuery<
      Rv,
      (arg: FixedBytes<32>) => bigint | undefined,
      FixedBytes<32>
    >
  ...
  /**
   * Pallet `Tracks`'s storage queries
   **/
  tracks: {
    /**
     * Storage of the next identifier to help identifying new MIDDS.
  ...
  /**
   * Pallet `Releases`'s storage queries
   **/
  releases: {
    /**
     * Storage of the next identifier to help identifying new MIDDS.
