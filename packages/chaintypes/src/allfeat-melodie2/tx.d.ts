...
export interface ChainTx<Rv extends RpcVersion>
  ...
  utility: {
     ...
     * or both.
     *
     * @param {MelodieRuntimeRuntimeCallLike} main
     * @param {MelodieRuntimeRuntimeCallLike} fallback
     **/
  ...
  /**
   * Pallet `PartyIdentifiers`'s transaction calls
   **/
  partyIdentifiers: {
    /**
     *
     * @param {MiddsPartyIdentifier} midds
     **/
    register: GenericTxCall<
      Rv,
      (midds: MiddsPartyIdentifier) => ChainSubmittableExtrinsic<
        Rv,
        {
          pallet: 'PartyIdentifiers'
          palletCall: {
            name: 'Register'
            params: { midds: MiddsPartyIdentifier }
          }
        }
      >
    >
    ...
    /**
     *
     * @param {bigint} middsId
     **/
    unregister: GenericTxCall<
      Rv,
      (middsId: bigint) => ChainSubmittableExtrinsic<
        Rv,
        {
          pallet: 'PartyIdentifiers'
          palletCall: {
            name: 'Unregister'
            params: { middsId: bigint }
          }
        }
      >
    >
  ...
  musicalWorks: {
    /**
     *
     * @param {MiddsMusicalWork} midds
     **/
    register: GenericTxCall<
      Rv,
      (midds: MiddsMusicalWork) => ChainSubmittableExtrinsic<
        Rv,
        {
          pallet: 'MusicalWorks'
          palletCall: {
            name: 'Register'
            params: { midds: MiddsMusicalWork }
          }
        }
      >
    >
  ...
  /**
   * Pallet `Tracks`'s transaction calls
   **/
  tracks: {
    /**
     *
     * @param {MiddsTrack} midds
     **/
    register: GenericTxCall<
      Rv,
      (midds: MiddsTrack) => ChainSubmittableExtrinsic<
        Rv,
        {
          pallet: 'Tracks'
          palletCall: {
            name: 'Register'
            params: { midds: MiddsTrack }
          }
        }
      >
    >
  ...
  /**
   * Pallet `Releases`'s transaction calls
   **/
  releases: {
    /**
     *
     * @param {MiddsRelease} midds
     **/
    register: GenericTxCall<
      Rv,
      (midds: MiddsRelease) => ChainSubmittableExtrinsic<
        Rv,
        {
          pallet: 'Releases'
          palletCall: {
            name: 'Register'
            params: { midds: MiddsRelease }
          }
        }
      >
    >
