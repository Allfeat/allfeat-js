...
export type MelodieRuntimeRuntimeEvent =
  ...
  | { pallet: 'PartyIdentifiers'; palletEvent: PalletMiddsEvent }
  | { pallet: 'MusicalWorks'; palletEvent: PalletMiddsEvent }
  | { pallet: 'Tracks'; palletEvent: PalletMiddsEvent }
  | { pallet: 'Releases'; palletEvent: PalletMiddsEvent }
...
export type PalletMiddsEvent =
  | {
      ...
      data: { provider: AccountId32; middsId: bigint; dataColateral: bigint }
    }
  | { name: 'MiddsUnregistered'; data: { middsId: bigint } }
...
export type PalletUtilityCall =
  ...
  | {
      name: 'IfElse'
      params: {
        main: MelodieRuntimeRuntimeCall
        fallback: MelodieRuntimeRuntimeCall
      }
    }
  /**
   * Dispatches a function call with a provided origin.
...
export type PalletUtilityCallLike =
  ...
  | {
      name: 'IfElse'
      params: {
        main: MelodieRuntimeRuntimeCallLike
        fallback: MelodieRuntimeRuntimeCallLike
      }
    }
  /**
   * Dispatches a function call with a provided origin.
...
export type MelodieRuntimeRuntimeCall =
  ...
  | { pallet: 'PartyIdentifiers'; palletCall: PalletMiddsCall }
  | { pallet: 'MusicalWorks'; palletCall: PalletMiddsCall002 }
  | { pallet: 'Tracks'; palletCall: PalletMiddsCall003 }
  | { pallet: 'Releases'; palletCall: PalletMiddsCall004 }
...
export type MelodieRuntimeRuntimeCallLike =
  ...
  | { pallet: 'PartyIdentifiers'; palletCall: PalletMiddsCallLike }
...
export type PalletMiddsCall =
  | { name: 'Register'; params: { midds: MiddsPartyIdentifier } }
...
export type PalletMiddsCall002 =
  | { name: 'Register'; params: { midds: MiddsMusicalWork } }
  | { name: 'Unregister'; params: { middsId: bigint } }
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 **/
export type PalletMiddsCall003 =
  | { name: 'Register'; params: { midds: MiddsTrack } }
  | { name: 'Unregister'; params: { middsId: bigint } }

export type PalletMiddsCallLike003 =
  | { name: 'Register'; params: { midds: MiddsTrack } }
  | { name: 'Unregister'; params: { middsId: bigint } }

export type MiddsTrack = {
  isrc: Bytes
  musicalWork: bigint
  artist: bigint
  producers: Array<bigint>
  performers: Array<bigint>
  contributors: Array<bigint>
  title: Bytes
  titleAliases: Array<Bytes>
  recordingYear: number
  genre: MiddsGenreMusicGenre
  genreExtras: Array<MiddsGenreMusicGenre>
...
export type MiddsGenreMusicGenre =
  | { type: 'African'; value?: MiddsGenreAfricanSubtype | undefined }
  | { type: 'Alternative'; value?: MiddsGenreAlternativeSubtype | undefined }
  | { type: 'Arabic'; value?: MiddsGenreArabicSubtype | undefined }
  | { type: 'Asian'; value?: MiddsGenreAsianSubtype | undefined }
  | { type: 'Blues'; value?: MiddsGenreBluesSubtype | undefined }
  | { type: 'Brazilian'; value?: MiddsGenreBrazilianSubtype | undefined }
  | {
      type: 'ChildrenMusic'
      value?: MiddsGenreChildrenMusicSubtype | undefined
    }
  | {
      type: 'ChristianAndGospel'
      value?: MiddsGenreChristianAndGospelSubtype | undefined
    }
  | { type: 'Country'; value?: MiddsGenreCountrySubtype | undefined }
  | { type: 'Dance'; value?: MiddsGenreDanceSubtype | undefined }
  | {
      type: 'EasyListening'
      value?: MiddsGenreEasyListeningSubtype | undefined
    }
  | { type: 'Electronic'; value?: MiddsGenreElectronicSubtype | undefined }
  | { type: 'Folk'; value?: MiddsGenreFolkSubtype | undefined }
  | { type: 'HipHopRap'; value?: MiddsGenreHipHopRapSubtype | undefined }
  | { type: 'Indian'; value?: MiddsGenreIndianSubtype | undefined }
  | { type: 'Jazz'; value?: MiddsGenreJazzSubtype | undefined }
  | { type: 'Latin'; value?: MiddsGenreLatinSubtype | undefined }
  | { type: 'Metal'; value?: MiddsGenreMetalSubtype | undefined }
  | { type: 'Pop'; value?: MiddsGenrePopSubtype | undefined }
  | { type: 'RAndBSoul'; value?: MiddsGenreRAndBSoulSubtype | undefined }
  | { type: 'Reggae'; value?: MiddsGenreReggaeSubtype | undefined }
  | { type: 'Relaxation'; value?: MiddsGenreRelaxationSubtype | undefined }
  | { type: 'Rock'; value?: MiddsGenreRockSubtype | undefined }
  | { type: 'Various'; value?: MiddsGenreVariousSubtype | undefined }
  | {
      type: 'WorldMusicRegionalFolklore'
      value?: MiddsGenreWorldMusicRegionalFolkloreSubtype | undefined
    }

export type MiddsGenreAfricanSubtype =
  | 'Afrikaans'
  | 'AfroBashment'
  | 'AfroPop'
  | 'AfroSoul'
...
export type MiddsGenreAlternativeSubtype =
  | 'ElectronicEBM'
  | 'EmoPunk'
  | 'Gothic'
  | 'Grunge'
...
export type MiddsGenreArabicSubtype =
  | 'AlgerianRai'
  | 'Amazigh'
  | 'Arabesque'
  | 'EgyptianChaabiat'
...
export type MiddsGenreAsianSubtype =
  | 'Chinese'
...
export type MiddsGenreBluesSubtype = 'ContemporaryBlues' | 'TraditionalBlues'

export type MiddsGenreBrazilianSubtype =
  | 'Arrocha'
  | 'Axe'
  | 'Baiao'
  | 'BaileFunk'
...
export type MiddsGenreChildrenMusicSubtype = 'Holiday' | 'Lullabies' | 'Stories'

export type MiddsGenreChristianAndGospelSubtype =
  | 'Arabic'
...
export type MiddsGenreCountrySubtype = 'Contemporary' | 'Pop' | 'Traditional'

export type MiddsGenreDanceSubtype =
  | 'AcidHouse'
  | 'AfroHouse'
  | 'Amapiano'
  | 'BassHouse'
...
export type MiddsGenreEasyListeningSubtype = 'Lounge' | 'Swing' | 'Vocal'

export type MiddsGenreElectronicSubtype =
  | 'Ambient'
  | 'DeepDubstepGrime'
  | 'Dubstep'
...
export type MiddsGenreFolkSubtype =
  | 'Acoustic'
  | 'Contemporary'
  | 'Indie'
  | 'Pop'

export type MiddsGenreHipHopRapSubtype =
  | 'AfricanDrill'
  | 'AfricanHipHop'
  | 'AlgerianHipHop'
  | 'Alternative'
...
export type MiddsGenreIndianSubtype =
  | 'Assamese'
  | 'AssameseSoundtrack'
  | 'Bengali'
  | 'BengaliSoundtrack'
...
export type MiddsGenreJazzSubtype =
  | 'Bebop'
  | 'BigBand'
  | 'Classic'
  | 'Contemporary'
...
export type MiddsGenreLatinSubtype =
  | 'ArgentineCuarteto'
  | 'ArgentineCumbia'
  | 'ArgentineFolklore'
  | 'Baladas'
...
export type MiddsGenreMetalSubtype =
  | 'BlackMetal'
  | 'DeathMetal'
  | 'Deathcore'
  | 'Djent'
...
export type MiddsGenrePopSubtype =
  | 'Alternative'
  | 'Arabic'
  | 'Batak'
  | 'Brazilian'
...
export type MiddsGenreRAndBSoulSubtype =
  | 'Arabic'
  | 'Contemporary'
  | 'Disco'
  | 'FunkAndSoul'
...
export type MiddsGenreReggaeSubtype =
  | 'BrazilianReggae'
  | 'CaribbeanDancehall'
  | 'CaribbeanReggae'
  | 'Dancehall'
...
export type MiddsGenreRelaxationSubtype = 'BaliSpa' | 'Meditation' | 'World'

export type MiddsGenreRockSubtype =
  | 'Alternative'
  | 'BritPopRock'
  | 'Classic'
  | 'Experimental'
...
export type MiddsGenreVariousSubtype =
  | 'Audiobook'
  | 'AudiobookChildren'
  | 'AudiobookComedy'
...
export type MiddsGenreWorldMusicRegionalFolkloreSubtype =
  | 'Australian'
  | 'CajunCreole'
  | 'EasternEuropean'
  | 'Ethnic'
...
export type MiddsTrackTrackVersion =
  | 'Original'
  | 'RadioEdit'
  | 'Extended'
  | 'Instrumental'
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 **/
export type PalletMiddsCall004 =
  | { name: 'Register'; params: { midds: MiddsRelease } }
  | { name: 'Unregister'; params: { middsId: bigint } }

export type PalletMiddsCallLike004 =
  | { name: 'Register'; params: { midds: MiddsRelease } }
  | { name: 'Unregister'; params: { middsId: bigint } }

export type MiddsRelease = {
  eanUpc: Bytes
  artist: bigint
  producers: Array<bigint>
  tracks: Array<bigint>
  distributorName: Bytes
  manufacturerName: Bytes
  coverContributors: Array<Bytes>
  title: Bytes
  titleAliases: Array<Bytes>
  releaseType: MiddsReleaseReleaseType
  format: MiddsReleaseReleaseFormat
  packaging: MiddsReleaseReleasePackaging
  status: MiddsReleaseReleaseStatus
  date: MiddsUtilsDate
  country: MiddsUtilsCountry
}

export type MiddsReleaseReleaseType =
  | 'Lp'
  | 'DoubleLp'
  | 'Ep'
  | 'Single'
...
export type MiddsReleaseReleaseFormat =
  | 'Cd'
  | 'DoubleCd'
  | 'Vynil7'
  | 'Vinyl10'
...
export type MiddsReleaseReleasePackaging = 'Digipack' | 'JewelCase' | 'SnapCase'

export type MiddsReleaseReleaseStatus =
  | 'Official'
  | 'Promotional'
  | 'ReRelease'
  | 'SpecialEdition'
...
export type MiddsUtilsDate = { year: number; month: number; day: number }

export type MiddsUtilsCountry =
  | 'Ad'
  | 'Ae'
  | 'Af'
  | 'Ag'
...
export type MelodieRuntimeRuntimeHoldReason =
  ...
  | { type: 'PartyIdentifiers'; value: PalletMiddsHoldReason }
  | { type: 'MusicalWorks'; value: PalletMiddsHoldReason }
  | { type: 'Tracks'; value: PalletMiddsHoldReason }
  | { type: 'Releases'; value: PalletMiddsHoldReason }
...
export type MelodieRuntimeRuntimeError =
  ...
  | { pallet: 'PartyIdentifiers'; palletError: PalletMiddsError }
  | { pallet: 'MusicalWorks'; palletError: PalletMiddsError }
  | { pallet: 'Tracks'; palletError: PalletMiddsError }
  | { pallet: 'Releases'; palletError: PalletMiddsError }
