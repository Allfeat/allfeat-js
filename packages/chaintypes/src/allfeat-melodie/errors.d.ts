...
export interface ChainErrors<Rv extends RpcVersion>
  ...
  /**
   * Pallet `PartyIdentifiers`'s errors
   **/
  partyIdentifiers: {
    /**
     ...
     **/
    MiddsNotFound: GenericPalletError<Rv>
     ...
     **/
    UnregisterLockedNoVoting: GenericPalletError<Rv>
